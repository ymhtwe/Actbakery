                    ...
                    <tr key={r.id} className={`border-b border-[#E5E7EB]/60 hover:bg-[#FAF6EC] transition-colors ${selectedIds.has(r.id) ? "bg-[#FAF6EC]" : ""}`}>
                      ...
                      <td className="py-3.5 px-4">
                        ...
                        {new Date(r.updated_at).getTime() - new Date(r.created_at).getTime() > 5000 && (
                          <span className="ml-1.5 inline-block px-1.5 py-0.5 rounded text-[0.65rem] font-medium bg-blue-50 text-blue-500 border border-blue-200">Edited</span>
                        )}
                      </td>
                      <td className="py-3.5 px-4">
                        <div>
                    ...
                    <div className="flex items-start gap-2 min-w-0 flex-1">
                      ...
                      <div className="min-w-0">
                        <div className="flex items-center gap-1.5 flex-wrap">
                          ...
                          {new Date(r.updated_at).getTime() - new Date(r.created_at).getTime() > 5000 && (
                            <span className="inline-block px-1.5 py-0.5 rounded text-[0.65rem] font-medium bg-blue-50 text-blue-500 border border-blue-200">Edited</span>
                          )}
                        </div>
            ...
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  {new Date(detailReceipt.updated_at).getTime() - new Date(detailReceipt.created_at).getTime() > 5000 && (
                    <span className="inline-block px-1.5 py-0.5 rounded text-[0.65rem] font-medium bg-blue-50 text-blue-500 border border-blue-200">Edited</span>
                  )}
                </div>
              </div>
